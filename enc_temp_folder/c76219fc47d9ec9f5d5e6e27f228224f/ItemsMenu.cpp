...
bool ItemsMenu::Load()
{
    ...
    itemsButtons[0] = new GuiButton(0, { 384, (0 * 79) + 110, 830, 79 }, "Raw meat", sceneManager->audio, false);
    buttonItems[0] = 0;
    itemsButtons[0]->SetObserver(this);

    itemsButtons[1] = new GuiButton(1, { 384, (1 * 79) + 110, 830, 79 }, "Large raw meat", sceneManager->audio, false);
    buttonItems[1] = 1;
    itemsButtons[1]->SetObserver(this);

    itemsButtons[2] = new GuiButton(2, { 384, (2 * 79) + 110, 830, 79 }, "Cooked plate", sceneManager->audio, false);
    buttonItems[2] = 2;
    itemsButtons[2]->SetObserver(this);

    itemsButtons[3] = new GuiButton(3, { 384, (3 * 79) + 110, 830, 79 }, "Elaborated plate", sceneManager->audio, false);
    buttonItems[3] = 3;
    itemsButtons[3]->SetObserver(this);

    itemsButtons[4] = new GuiButton(4, { 384, (4 * 79) + 110, 830, 79 }, "Pint", sceneManager->audio, false);
    buttonItems[4] = 4;
    itemsButtons[4]->SetObserver(this);

    itemsButtons[5] = new GuiButton(5, { 384, (5 * 79) + 110, 830, 79 }, "Jug", sceneManager->audio, false);
    buttonItems[5] = 5;
    itemsButtons[5]->SetObserver(this);

    itemsButtons[6] = new GuiButton(6, { 384, (6 * 79) + 110, 830, 79 }, "Strong Ron", sceneManager->audio, false);
    buttonItems[6] = 6;
    ...
    // Load item sprites
    itemSprites[0] = sceneManager->tex->Load("sprites/items/item_rawmeat.png");
    itemSprites[1] = sceneManager->tex->Load("sprites/items/item_largerawmeat.png");
    itemSprites[2] = sceneManager->tex->Load("sprites/items/item_cookedplate.png");
    itemSprites[3] = sceneManager->tex->Load("sprites/items/item_elaboratedplate.png");
    itemSprites[4] = sceneManager->tex->Load("sprites/items/item_pint.png");
    itemSprites[5] = sceneManager->tex->Load("sprites/items/item_jug.png");
    itemSprites[6] = sceneManager->tex->Load("sprites/items/item_strongron.png");

    // Load empty item sprites
    itemSpritesEmpty[0] = sceneManager->tex->Load("sprites/items/item_rawmeat_empty.png");
    itemSpritesEmpty[1] = sceneManager->tex->Load("sprites/items/item_largerawmeat_empty.png");
    itemSpritesEmpty[2] = sceneManager->tex->Load("sprites/items/item_cookedplate_empty.png");
    itemSpritesEmpty[3] = sceneManager->tex->Load("sprites/items/item_elaboratedplate_empty.png");
    itemSpritesEmpty[4] = sceneManager->tex->Load("sprites/items/item_pint_empty.png");
    itemSpritesEmpty[5] = sceneManager->tex->Load("sprites/items/item_jug_empty.png");
    itemSpritesEmpty[6] = sceneManager->tex->Load("sprites/items/item_strongron_empty.png");
...
bool ItemsMenu::Draw()
{
    ...
    for (int i = 0; i < 7; i++)
    {
        int quantity = sceneManager->entityManager->quantity[i];
        
        if(quantity > 0)
            sceneManager->render->DrawTexture(itemSprites[i], 270, (i * 79 + 240));
        else
            sceneManager->render->DrawTexture(itemSpritesEmpty[i], 270, (i * 79 + 240));
